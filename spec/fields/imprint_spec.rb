...
describe ModsDisplay::Imprint do
  ...
  describe "labels" do
    ...
    it "should get the label from non-imprint origin info fields" do
      mods_display_imprint(@date_valid).fields.first.label.should == "Date Valid"
      mods_display_imprint(@edition).fields.first.label.should == "Edition"
    end
    ...
    it "should use the displayLabel when available" do
       ...
       mods_display_imprint(@edition_display_label).fields.map{|val| val.label }.should == ["EditionLabel", "EditionLabel"]
    end
  end
  ...
  describe "fields" do
    ...
    it "should get the text for non-imprint origin info fields" do
      ...
      mods_display_imprint(@edition).fields.first.values.should == ["The Edition"]
    end
